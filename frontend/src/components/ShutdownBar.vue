  ...
  <div class="shutdown-bar" >
    <div class="shutdown-inner">
      ...
      <span class="shutdown-text">
        日费 <strong>¥{{ appStore.serverStatus.dailyCost || '4.87' }}</strong>，
        余额 <strong>¥{{ appStore.serverStatus.totalFunds || 300 }}</strong>
        &nbsp;&middot;&nbsp; 已筹 <strong>¥{{ appStore.serverStatus.donatedAmount || 0 }}</strong>
        &nbsp;&middot;&nbsp; 可撑 <strong>{{ daysRemaining }}</strong>天
      </span>
